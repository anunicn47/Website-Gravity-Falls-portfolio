const designBio = {
    description: `Hey I'm Karan, (feel free to call me Raj, as many people struggle to pronounce the name). I'm an illustrator/ visual designer currently residing in India.
    ...
    caption: 'Depiction of Karan Raj.'
}
